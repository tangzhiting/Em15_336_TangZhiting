...
set_property PACKAGE_PIN W19 [get_ports {led_tri_o[0]}]
set_property PACKAGE_PIN U12 [get_ports {led_tri_o[1]}]
set_property PACKAGE_PIN V18 [get_ports {led_tri_o[2]}]
set_property PACKAGE_PIN Y17 [get_ports {led_tri_o[3]}]
